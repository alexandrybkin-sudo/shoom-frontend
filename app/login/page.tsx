    ...
    <div className="min-h-screen bg-ink text-fg font-sans flex flex-col items-center justify-center px-4 py-12">
      ...
      <div className="w-full max-w-sm">
        ...
        <div className="space-y-2.5 mb-5">
          <button
            onClick={() => social('yandex')}
            className="w-full flex items-center justify-center gap-2.5 bg-white hover:bg-white/90 text-[#1a1a1a] rounded-xl py-3 text-sm font-medium transition-colors"
          >
...
function YandexIcon() {
  return (
    <svg width="18" height="18" viewBox="0 0 18 18" aria-hidden>
      ...
      <text x="9" y="13.5" textAnchor="middle" fontSize="13" fontWeight="700" fill="#fff" fontFamily="Arial, sans-serif">Я</text>
    </svg>
  );
}
